...
def main():
    ...
    while continuare:
        ...
        if st.button("Salva dati"):
            ...
            # chiedere all'utente se vuole continuare o interrompere il processo
            continuare = st.button("Aggiungi un altro partecipante")
            
        else:
            # se l'utente non ha scelto di salvare i dati, interrompere il ciclo while
            continuare = False
